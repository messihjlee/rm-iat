...
flowers_insects_raw = read.csv('../../../../data/rmiat/Qwen3-8B/flowers_insects.csv')
...
instruments_weapons_raw = read.csv('../../../../data/rmiat/Qwen3-8B/instruments_weapons.csv')
...
race_original_raw = read.csv('../../../../data/rmiat/Qwen3-8B/race_original.csv')
...
race_bertrand_raw = read.csv('../../../../data/rmiat/Qwen3-8B/race_bertrand.csv')
...
race_nosek_raw = read.csv('../../../../data/rmiat/Qwen3-8B/race_nosek.csv')
...
career_family_raw = read.csv('../../../../data/rmiat/Qwen3-8B/career_family.csv')
...
math_arts_raw = read.csv('../../../../data/rmiat/Qwen3-8B/math_arts.csv')
...
science_arts_raw = read.csv('../../../../data/rmiat/Qwen3-8B/science_arts.csv')
...
mental_physical_raw = read.csv('../../../../data/rmiat/Qwen3-8B/mental_physical.csv')
...
young_old_raw = read.csv('../../../../data/rmiat/Qwen3-8B/young_old.csv')
